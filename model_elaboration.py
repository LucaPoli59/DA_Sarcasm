...
text_parent_backbone = keras_nlp.models.BertBackbone.from_preset("bert_tiny_en_uncased")
text_parent_processor = keras_nlp.models.BertPreprocessor.from_preset("bert_tiny_en_uncased")
text_parent_backbone.trainable = False


text_input = tf.keras.Input(shape=(), dtype=tf.string, name='text')
parent_input = tf.keras.Input(shape=(), dtype=tf.string, name='parent')

text_parent_layers = text_parent_processor([text_input, parent_input])
print(text_parent_layers)
text_parent_layers = text_parent_backbone(text_parent_layers)['pooled_output']
